...
public class hbaseApp {
    ...
    private void getTable() {
        ...
        System.out.println("[BLA} Getting the Table");
        try {
            admin = new HBaseAdmin(conf);
            System.out.println("Table exist: " + admin.tableExists(current_table));
            if (!admin.tableExists(current_table)) {
